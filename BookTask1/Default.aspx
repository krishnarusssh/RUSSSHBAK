...
$(".cd-dropdown-content").show();
    ...
    <script type="text/javascript">
		 function confirmation() {
            var answer = confirm("Are you sure you want to Book This Task.")
            //alert(answer);
            return answer;
        }
        ...
        function CallRequestQuote(ServiceCategory, ProductValue, ProductWeight, ReturnServiceCategory, ReturnProductValue, ReturnProductWeight, PickupAreaID, PickUpCityID, DropAreaID, DropCityID, PaymentMode, ApplyInsurance, PromoCode, TaskDate, IsExpress, TaskMode) {
            ...
            $.ajax({
                ...
                success: function OnComplete(result) {
                    ...
                    document.getElementById("subtotalFeeval").value = total;
        ...
        var unavailableDates = ["24-3-2016","6-9-2016"];
                        ...
                        success: function (xml) {
                            ...
                            $(xml).find('TIMESLOT').each(function () {
                                ...
                                if (ampm == 'pm') {
							        ...
							        // For 10 sept and 15 sept time booking 
                            var limitdate = document.getElementById("taskdate").value;
                            if (limitdate == '10/09/2016' || limitdate == '15/09/2016') {
                                for (i = pickuptime.options.length - 1; i >= 0; i--) {
                                    pickuptime.remove(i);
                                }
                                ...
                                $.ajax({
                                    ...
                                    success: function (xml) {
                                        ...
                                        var option = document.createElement('option');
                                        $(xml).find('TIMESLOT').each(function () {
                                            if (parseInt($(this).find('TimeSlotId').text()) <= 33) {
                                                var sValue = $(this).find('TimeSlotId').text();
                                                var sText = $(this).find('FromToTimeSlot').text();
                                                i = i + 1;
                                                var option1 = document.createElement('option');
            ...
            <div class="container" style="height: auto;">
                ...
                <div class="row " style="margin-top: 60px">
                    <div class="col-md-12 text-center" id="diverror" runat="server" style="color: red"></div>
					 <div   class="col-md-12 text-center"   runat="server" style="color: red;display:none;">Please note we are not accepting any pickup after 3 Pm On 10 September 2016 and 15 September 2016 . We are sorry for inconvenience cause to you</div>
			</div>		 
                            ...
                            <div class="fields">
                                <div class="screen3 mt20">
                                    ...
                                    <div class="float mt20">
                                        ...
                                        <div class="left grid50 pr10 relative">
                                            <i class="fa fa-map-marker icon2"></i>
                                            <input type="text" class="form-control" style="margin-left: 10px;" placeholder="Pincode"  id="ppincode" maxlength="6" name="ppincode" onkeypress="return isNumber(event)" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Pincode'" />
                                        </div>
                            ...
                            <div class="fields">
                                <div class="screen3 mt20">
                                    ...
                                    <div class="float mt20">
                                        ...
                                        <div class="left grid50 pr10 relative">
                                            <i class="fa fa-map-marker ico"></i>
                                            <input type="text" class="form-control" placeholder="Pincode" id="dpincode"  name="dpincode" maxlength="6" onkeypress="return isNumber(event)" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Pincode'" />
                                        </div>
...
<li>If the task is not cancelled 2 hours prior the pickup time. Cancellation fee of RS 100 would be applicable.</li>
                            ...
                            <div class="float mb10">
                                ...
                                <asp:Button class="btn-blue center-block" type="button" runat="server"  ID="btnSubmit" Text="BOOK TASK" OnClick="btnSubmit_Click"  OnClientClick="return confirmation();"  />
                            </div>
