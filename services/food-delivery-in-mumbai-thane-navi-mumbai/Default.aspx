<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="services_food_delivery_Default" %>
...
<head>
    ...
    <title>Food Delivery Anywhere In Mumbai – Visit Russsh.com!</title>
   <meta name="title" content="Food Delivery & Take Away In Mumbai|Download App| Russsh" />
   <meta name="description" content="We deliver food to your door-step from any restaurant of your choice. Pay Online or COD. Russsh delivers in Mumbai, Thane and Navi Mumbai. Call 8080808315!" />
    ...
    <form id="form1" runat="server">
        ...
        <div class="content">
            <div class="container" style="background: #e9e9eb;">
                <div class="row">
                    <div class="col-md-5">
                        <img src="https://www.russsh.com/services/food-delivery-in-mumbai-thane-navi-mumbai/images/food-item.png" class="img-responsive" alt="" title="" />
                    </div>
                    <div class="col-md-5 col-md-offset-1">
                        <div class="service-text">
                            <h1>Food Delivery</h1>
                            <p>Be it your precious Maa Ke Haath Ka Khana or a delicious meal from your favourite restaurant , we will deliver it for you within few hours.</p>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row paddingtb-40 service-all">
                <div class="col-md-6">
                    <div>
                        <h2>About our FOOD DELIVERY service</h2>
                        <p>
                            Be it your precious Maa Ke Haath Ka Khana or a delicious meal from your favourite restaurant , we will deliver it for you within few hours of placing a request via phone call, <a href="https://play.google.com/store/apps/details?
id=com.russsh.admin.russsh&hl=en">app</a> or the <a href="https://russsh.com/">website</a>. In addition to commuting all over Mumbai, we ensure the safety and protect your package from all sorts of damage. If proven otherwise, we promise to reimburse you the full amount.
                        </p>
                    </div>
                </div>
                <div class="col-md-6">
                    <img src="../food-delivery-in-mumbai-thane-navi-mumbai/images/Food-Delivery.svg" class="img-responsive center-block pd-t50" alt="" />
                </div>
            </div>
            <div class="row paddingtb-40 service-all">
                <div class="col-md-6 col-md-push-6">
					<div class="service-padding">
                        <h2>3 Massive benefits of using Russsh while delivering a food</h2>
                        <ul>
                ...
                <div class="col-md-6 col-md-pull-6">
                     <img src="../service-material/images/3-massive-benefits.svg" style="padding-top: 30px;" class="img-responsive center-block" alt="" />
                </div>
            </div>
            <div class="row paddingtb-40 service-all">
                <div class="col-md-6">
