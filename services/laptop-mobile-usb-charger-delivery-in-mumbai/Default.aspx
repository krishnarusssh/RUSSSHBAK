<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="services_electronic_items_delivery_Default" %>
...
<head>
    ...
    <title>Laptop & Mobile Delivery In Mumbai – Visit Russsh.com!</title>
   <meta name="title" content="Same Day Delivery|Laptop, Mobile, Charger| Download App" />
   <meta name="description" content="We deliver laptop, mobile, charger, xbox, playstation, dvds,  usb etc. Pay Online or COD. Russsh delivers in Mumbai, Thane and Navi Mumbai. Call 8080808315!" />
    ...
    <form id="form1" runat="server">
        ...
        <div class="content">
            <div class="container" style="background: #e9e9eb;">
                <div class="row">
                    <div class="col-md-5">
                        <img src="https://www.russsh.com/services/laptop-mobile-usb-charger-delivery-in-mumbai/images/electronic-item.png" style="margin-left: 10px;" class="img-responsive" alt="" title="" />
                    </div>
                    <div class="col-md-6 col-md-offset-1">
                        <div class="service-text">
                            <h1>Electronic Items Delivery
                                <br />
                                In Mumbai</h1>
                            <p>We home deliver all kinds of electronic items without breaking a sweat.</p>
                        </div>
                    </div>
                </div>
                <div class="row service-bottom">
                    <div class="service-box">
                        <div class="internal">
                            <p>User Rating</p> <p>Coming Soon</p>
                          <%--  <h3>4.0
                                <img src="../service-material/images/rating.jpg" alt="" title="" /></h3>--%>
                        </div>
                        <div class="internal">
                            <p>Total Electroics Delivered</p>
            ...
            <div class="row">
                <div class="col-md-12 paddingtb-20">
                    <ul class="breadcrumbs">
                        ...
                        <li>Electronic items Delivery</li>
                    </ul>
                </div>
            </div>
        </div>
        <div class="container">
            <div class="row paddingtb-40 service-all">
                <div class="col-md-6">
                    <h2>About our ELECTRONIC ITEMS DELIVERY Service</h2>
                    <p><strong>Need a hard drive from your friend’s place for your presentation starting in no time?</strong></p>
                    <p>Russsh delivers all sorts of electronic items ranging from computers, laptops, hard drives, usb sticks, gaming consoles along with considering the special attention and care these items require. All you have to do is place a delivery request from our <a href="https://play.google.com/store/apps/details?id=com.russsh.admin.russsh&hl=en">app</a>/<a href="https://russsh.com/">website</a> and our dedicated team of customer support will guide you, all along the way.</p>
                    <p>We take full responsibility of your electronic devices. Any sort of damage done during the transit, whether big or small is all taken care by us followed by full reimbursement.</p>
                    <p><strong>Note: You will have to take full responsibility of the packaging.</strong></p>

                </div>
                <div class="col-md-6">
                    <img src="../laptop-mobile-usb-charger-delivery-in-mumbai/images/Electronic-item.svg" width="195" height="145" style="padding-top: 105px;" class="img-responsive center-block" alt="" />
                </div>
            </div>
            <div class="row paddingtb-40 service-all">
                <div class="col-md-6 col-md-push-6">
					<div class="service-padding">
                        <h2>3 Massive benefits of using Russsh while delivering electronic items</h2>
                        <ul>
