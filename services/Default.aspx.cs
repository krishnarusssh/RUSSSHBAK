            ...
            if (Session != null)
            {
                if (Session["CLIENT_NAME"] != null && Session["CLIENT_NAME"] != "")
                {
                   ...
                   // booklink2.InnerHtml = "<a class='book-now' href='https://www.russsh.com/BookTask/'>Book Now</a>";
                    cake_delivery_link1.InnerHtml = "<a href='" + innerlink + "1'>Book Now</a>";
                    Clothes_delivery_link1.InnerHtml = "<a href='" + innerlink + "9'>Book Now</a>";
                    Grocery_delivery_link1.InnerHtml = "<a href='" + innerlink + "10'>Book Now</a>";
                    food_delivery_link1.InnerHtml = "<a href='" + innerlink + "3'>Book Now</a>";
                    gift_delivery_link1.InnerHtml = "<a href='" + innerlink + "7'>Book Now</a>";
                    flower_delivery_link1.InnerHtml = "<a href='" + innerlink + "2'>Book Now</a>";
                    electronic_delivery_link1.InnerHtml = "<a href='" + innerlink + "11'>Book Now</a>";

                    bakery_delivery_link1.InnerHtml = "<a href='" + innerlink + "13'>Book Now</a>";
                    chocolate_delivery_link1.InnerHtml = "<a href='" + innerlink + "14'>Book Now</a>";
                    cash_delivery_link1.InnerHtml = "<a href='" + innerlink + "19'>Book Now</a>";
                    document_delivery_link1.InnerHtml = "<a href='" + innerlink + "16'>Book Now</a>";
                    Bulk_delivery_link1.InnerHtml = "<a href='" + innerlink + "4'>Book Now</a>";
                    Parcel_delivery_link1.InnerHtml = "<a href='" + innerlink + "17'>Book Now</a>";
                ...
                else
                {
                   ...
                   // booklink1.InnerHtml = "<a class='book-now' href='#' data-toggle='modal' data-target='#login'>Book Now</a>";
                    ...
                    cake_delivery_link1.InnerHtml = " <a href='#' data-toggle='modal' data-target='#login'>Book Now</a>";
                    Clothes_delivery_link1.InnerHtml = " <a href='#' data-toggle='modal' data-target='#login'>Book Now</a>";
                    Grocery_delivery_link1.InnerHtml = " <a href='#' data-toggle='modal' data-target='#login'>Book Now</a>";
                    food_delivery_link1.InnerHtml = " <a href='#' data-toggle='modal' data-target='#login'>Book Now</a>";
                    gift_delivery_link1.InnerHtml = " <a href='#' data-toggle='modal' data-target='#login'>Book Now</a>";
                    flower_delivery_link1.InnerHtml = " <a href='#' data-toggle='modal' data-target='#login'>Book Now</a>";
                    electronic_delivery_link1.InnerHtml = " <a href='#' data-toggle='modal' data-target='#login'>Book Now</a>";

                    bakery_delivery_link1.InnerHtml = " <a href='#' data-toggle='modal' data-target='#login'>Book Now</a>";
                    chocolate_delivery_link1.InnerHtml = " <a href='#' data-toggle='modal' data-target='#login'>Book Now</a>";
                    cash_delivery_link1.InnerHtml = " <a href='#' data-toggle='modal' data-target='#login'>Book Now</a>";
                    document_delivery_link1.InnerHtml = " <a href='#' data-toggle='modal' data-target='#login'>Book Now</a>";
                    Bulk_delivery_link1.InnerHtml = " <a href='#' data-toggle='modal' data-target='#login'>Book Now</a>";
                    Parcel_delivery_link1.InnerHtml = " <a href='#' data-toggle='modal' data-target='#login'>Book Now</a>";
                }
                //coding for Count
