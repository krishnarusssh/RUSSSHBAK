<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="OrderCancellation_Default" %>
...
<div id="home" class="innerbackground">
 ...
 <div class="banner">
    <div class="container"> 
  <!--  logon-->
    <div class="col-md-9 col-md-offset-2 yourordersbox" style="height:auto;margin-top:141px;">
    <h3>Order Details: #<span><asp:Label ID="lblTaskID" runat="server" style="font-weight: 700"></asp:Label></span></h3>
    <p><b><asp:Label ID="lblmsg" runat="server"></asp:Label></b></p>
        <asp:TextBox id="txtresone" runat="server" placeholder="Kindly mention reason for cancellation" Width="80%" ></asp:TextBox>
       <br><br>
        <p><asp:Button ID="btnconfirm" runat="server" Text="Delete" CssClass="ORDERS_btn avt" OnClick="btnconfirm_Click"  />
     <%--<input name="ORDERS" value="ORDERS" class="ORDERS_btn avt">--%>
        <asp:Button ID="btnorders" runat="server" Text="<< Back" CssClass="ORDERS_btn avt" OnClick="btnorders_Click" /></p>
