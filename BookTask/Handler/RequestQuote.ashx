<%@ WebHandler Language="C#" Class="RequestQuote" %>
using System;
using System.Web;
using System.Data;
using System.Text;
...
public class RequestQuote : IHttpHandler {
    ...
    public void ProcessRequest(HttpContext context)
    {
        ...
        if (context.Request.QueryString["PRODUCTWEIGHT"] != "" && context.Request.QueryString["PRODUCTWEIGHT"] != null)
        {
            ...
            if (ProductWeight > 0 && ProductWeight <= 5)
            {
                ProductWeightval = 0;
            }
            if (ProductWeight > 5 && ProductWeight <= 10)
            {
                ProductWeightval = 100;
            }
            if (ProductWeight > 10 && ProductWeight <= 15)
            {
                ProductWeightval = 200;
            }
            if (ProductWeight > 15 && ProductWeight <= 20)
            {
                ProductWeightval = 300;
            }
            if (ProductWeight > 20 && ProductWeight <= 25)
            {
                ProductWeightval = 400;
            }
            if (ProductWeight > 25 && ProductWeight <= 30)
            {
                ProductWeightval = 500;
        ...
        if (context.Request.QueryString["RETURNPRODUCTWEIGHT"] != "" && context.Request.QueryString["RETURNPRODUCTWEIGHT"] != null)
        {
            ...
            if (ReturnProductWeight > 0 && ReturnProductWeight <= 5)
            {
                ReturnProductWeightval = 0;
            }
            if (ReturnProductWeight > 5 && ReturnProductWeight <= 10)
            {
                ReturnProductWeightval = 100;
            }
            if (ReturnProductWeight > 10 && ReturnProductWeight <= 15)
            {
                ReturnProductWeightval = 200;
            }
            if (ReturnProductWeight > 15 && ReturnProductWeight <= 20)
            {
                ReturnProductWeightval = 300;
            }
            if (ReturnProductWeight > 20 && ReturnProductWeight <= 25)
            {
                ReturnProductWeightval = 400;
            }
            if (ReturnProductWeight > 25 && ReturnProductWeight <= 30)
            {
                ReturnProductWeightval = 500;

            }
            if (ReturnProductWeight > 30)
            {
                ReturnProductWeightval = 500;
            }
        }
        ...
        try
        {
            ...
            cmd.Parameters.Add("@ProductWeight", SqlDbType.Int).Value = ProductWeightval;
            ...
            int i = 0;
            ClientXMl = dtable.Rows[0].ItemArray[0].ToString().Trim() + "," + dtable.Rows[0].ItemArray[1].ToString().Trim() + "," + dtable.Rows[0].ItemArray[2].ToString().Trim() + "," + dtable.Rows[0].ItemArray[3].ToString().Trim() + "," + dtable.Rows[0].ItemArray[4].ToString().Trim() + "," + dtable.Rows[0].ItemArray[5].ToString().Trim() + "," + dtable.Rows[0].ItemArray[6].ToString().Trim() + "," + IsExpress.ToString();
            //  ClientXMl = ds.GetXml();
        }
        catch (Exception e)
        {
