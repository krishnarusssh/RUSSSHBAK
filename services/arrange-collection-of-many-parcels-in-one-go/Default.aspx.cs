...
public partial class services_bulk_delivery_Default : System.Web.UI.Page
{
        ...
        if (!Page.IsPostBack)
        {
            if (Session != null)
            {
                if (Session["CLIENT_NAME"] != null && Session["CLIENT_NAME"] != "")
                {
                    ...
                    lnkBook1.InnerHtml = "<a class='" + css + "' href='" + innerlink + "4'>Book Now</a>";
                    lnkBook2.InnerHtml = "<a class='" + css + "' href='" + innerlink + "4'>Book Now</a>";
                ...
                else
                {
                    ...
                    lnkBook2.Style.Value = "class:book-btn;";
                    lnkBook2.InnerHtml = " <a href='#' data-toggle='modal' data-target='#login'>Book Now</a>";
                ...
                if (dss.Tables.Count >= 1)
                {
                    if (dss.Tables[0].Rows.Count > 0)
                    {
                        ...
                        ntotal.InnerHtml = dss.Tables[0].Rows[3].ItemArray[2].ToString() ;
                    }
                }
            }
        }
