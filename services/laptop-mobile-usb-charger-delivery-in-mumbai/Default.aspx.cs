...
public partial class services_electronic_items_delivery_Default : System.Web.UI.Page
{
        ...
        if (!Page.IsPostBack)
        {
            if (Session != null)
            {
                if (Session["CLIENT_NAME"] != null && Session["CLIENT_NAME"] != "")
                {
                    ...
                    string css = "book-btn";
                    lnkBook1.InnerHtml = "<a class='" + css + "'  href='" + innerlink + "11'>Book Now</a>";
                    lnkBook2.InnerHtml = "<a class='" + css + "' href='" + innerlink + "11'>Book Now</a>";
                ...
                if (dss.Tables.Count >= 1)
                {
                    if (dss.Tables[0].Rows.Count > 0)
                    {
                        ...
                        ntotal.InnerHtml = dss.Tables[0].Rows[10].ItemArray[2].ToString();
                    }
                }
            }
        }
