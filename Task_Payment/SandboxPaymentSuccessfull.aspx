<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SandboxPaymentSuccessfull.aspx.cs" Inherits="Task_Payment_SandboxPaymentSuccessfull" %>
    ...
    <form id="Form1"  method="post" runat="server">
        ...
        <div id="home" class="innerbackground">
            ...
            <div class="banner">
                <div class="container">
                    ...
                    <div class="col-md-9 yourordersbox">
                           <h3 id="title1" runat="server">Congratulation!<br /> Task Booked Successfully.   <br></h3>
                        <p>
            ...
            if (lastName != null) {
             ...
             if (flag) {
    %>
       <div style="display:none;"> Your Unique Transaction/Order Id : <%=txnId%><br/></div>
        Transaction Status : <%=txnStatus%><br/>
    <% } else { %>
        <label width="125px;">Citrus Response Signature and Our (Merchant) Signature Mis-Mactch</label>
    <% } %>
<br /><br />
                             <a href="../BookTask6" style=" font-size:24px;"><u>Book Another Task</u></a>
                        </p>
                    </div>
