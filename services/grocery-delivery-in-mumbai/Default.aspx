<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="services_grocery_delivery_Default" %>
...
<head>
    ...
    <title>Grocery Delivery Anywhere In Mumbai – Visit Russsh.com!</title>
    <meta name="title" content="Grocery Delivery In Mumbai, Thane| Download App| Russsh" />
    <meta name="description" content="Hire errand runner to buy your groceries like organic food, cheese & wine. Pay Online or COD. Russsh delivers in Mumbai, Thane and Navi Mumbai. Call 8080808315!" />
    ...
    <form id="form1" runat="server">
        ...
        <div class="content">
            <div class="container" style="background: #e9e9eb;">
                <div class="row">
                    <div class="col-md-5">
                        <img src="https://www.russsh.com/services/grocery-delivery-in-mumbai/images/grocery-item.png" style="margin-left: 10px;" class="img-responsive" alt="" title="" />
                    </div>
                    <div class="col-md-5 col-md-offset-1">
                        <div class="service-text">
                            <h1>Grocery Delivery In Mumbai</h1>
                            <p>We deliver groceries to your door in 90mins.</p>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row paddingtb-40 service-all">
                <div class="col-md-6">
                    <div>
                        <h2>About our GROCERY SHOPPING DELIVERY</h2>
                        <p>Hate grocery shopping? Don’t worry, we can do it for you. All you have to do is share a list of grocery items with us, let us know the pick up point and we’ll take care of the rest. Now there’s no need of taking out that extra hour of your busy schedule for going to the vegetable market because we are one call away. You can request a delivery giving us a notice of at least 24 hours (starting at Rs.200), or a few hours for same day delivery (starting at Rs.250). We also accept last minute requests to deliver within 2 hours (starting at Rs.350).</p>
                    </div>
                </div>
                <div class="col-md-6">
                    <img src="../grocery-delivery-in-mumbai/images/Grocery-delivery.svg" class="img-responsive center-block pd-t50" alt="" />
                </div>
            </div>
            <div class="row paddingtb-40 service-all">
                <div class="col-md-6 col-md-push-6">
					 <div class="service-padding">
                        <h2>3 Massive benefits of using Russsh while delivering grocery item</h2>
                        <ul>
