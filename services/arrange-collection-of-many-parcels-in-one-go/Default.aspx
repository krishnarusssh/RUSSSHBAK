<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="services_bulk_delivery_Default" %>
...
<head>
    ...
    <title>Send Parcels To Different Addresses – Visit Russsh.com!</title>
    <meta name="title" content="Arrange Collection Of Many Parcels In One Go| Russsh" />
    <meta name="description" content="We arrange collection of many parcels at one go for a low price. Currently Available in Mumbai, Thane & Navi Mumbai. Fill in the contact us form to get a quote." />
    ...
    <form id="Form1" name="form1" runat="server">
        ...
        <div class="content">
            <div class="container" style="background: #e9e9eb;">
                <div class="row">
                    <div class="col-md-5">
                        <img src="https://www.russsh.com/services/arrange-collection-of-many-parcels-in-one-go/images/bulk-item.png" style="margin-left: 10px;" class="img-responsive" alt="Collection of many parcels in one go
" title="" />
                    </div>
                    <div class="col-md-5 col-md-offset-1">
                        <div class="service-text">
                            <h1>Bulk Deliveries In Mumbai</h1>
                            <p>Ship packages in bulk frugally.</p>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row paddingtb-40 service-all">
                <div class="col-md-6">
                    <h2>About our BULK DELIVERY service</h2>
                    <p>Russsh delivers items in bulk keeping the transportation and overhead costs in mind. Things that require to go from point A to point B without much hassle in between should be at the top of your list. And that’s what we stand for. You can rely on us as we take full responsibility of your items. You can place a delivery via <a href="https://play.google.com/store/apps/details?id=com.russsh.admin.russsh&hl=en">app</a>/<a href="https://russsh.com/">website</a> by giving us a notice of at least 24 hours or minimum 2 hours. Next step: Sit back and relax.</p>
                    <p><strong>Note: You will have to take full responsibility of the packaging.</strong></p>
                </div>
                <div class="col-md-6">
                    <img src="../arrange-collection-of-many-parcels-in-one-go/images/Bulk-Delivery.svg" style="padding-top: 70px;" class="img-responsive center-block" alt="Bulk delivery in Mumbai, Thane and Navi Mumbai
" />
                </div>
            </div>
            <div class="row paddingtb-40 service-all">
                <div class="col-md-6 col-md-push-6">
					<div class="service-padding">
                        <h2>3 Massive benefits of using Russsh while delivering items in bulk</h2>
                        <ul>
                ...
                <img src="../service-material/images/3-massive-benefits.svg" style="padding-top: 65px;" class="img-responsive center-block" alt="" />    
                </div>
            </div>
            <div class="row paddingtb-40 service-all">
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    <img src="../service-material/images/what-other-want.svg" style="padding-top: 50px;" class="img-responsive center-block" alt="" />
                </div>
            </div>
        </div>
