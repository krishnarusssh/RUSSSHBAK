<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="services_parcel_delivery_Default" %>
...
<head>
    ...
    <title>Parcel Delivery Anywhere In Mumbai – Visit Russsh.com!</title>
    <meta name="title" content="Send a Parcel Today| Download App| Russsh" />
    <meta name="description" content="Send a parcel weighing up to 5kg on the same day. Express deliveries available. Cash on delivery. Services in Mumbai, Thane and Navi Mumbai. Download App" />
    ...
    <form id="form1" runat="server">
        ...
        <div class="content">
            <div class="container" style="background-color: #CCC;">
                <div class="row">
                    <div class="col-md-5">
                        <img src="https://www.russsh.com/services/send-a-parcel/images/bulk-item.png" style="margin-left: 10px;" class="img-responsive" alt="Send Parcel in Mumbai, Thane and Navi Mumbai
" title="" />
                    </div>
                    <div class="col-md-5 col-md-offset-1">
                        <div class="service-text">
                            <h1>Parcel Delivery In Mumbai</h1>
                            <p>Send any number of packages on the same day.</p>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row paddingtb-40 service-all">
                <div class="col-md-6">
                    <h2>About our PARCEL DELIVERY service</h2>
                    <p><strong>Desperate to send last-minute package or parcel to friends?</strong></p>
                    <p>Most of us instinctively link the need of sending a parcel or courier with a trip to the courier office like Professional courier, DTDC or Vichare couriers. Russsh has changed all that.</p>
                </div>
                <div class="col-md-6">
                    <img src="../send-a-parcel/images/Parcel-Delivery.svg" class="img-responsive center-block pd-30" alt="Parcel delivery in Mumbai, Thane and Navi Mumbai
" />
                </div>
            </div>
            <div class="row paddingtb-40 service-all">
                <div class="col-md-6 col-md-push-6">
					 <div class="service-padding">
                        <h2>3 Massive benefits of using Russsh while delivering parcel</h2>
                        <ul>
                            ...
                            <li><i class="fa fa-caret-right"></i> Send up to 5KG</li>
                        </ul>
                    </div>
                 
                </div>
                <div class="col-md-6 col-md-pull-6">
               <img src="../service-material/images/3-massive-benefits.svg" class="img-responsive center-block pd-t50" alt="Send Parcel Instantly" />
                </div>
            </div>
            <div class="row paddingtb-40 service-all">
                <div class="col-md-6">
                    <div class="service-padding">
                        ...
                        <p>We insure all parcels that are handled by us. The insurance fee is included as a part of the delivery fee. We take 100% responsibility of the cake. If the cake is damaged or lost during transit because of the negligence of one of our delivery staff, we will reimburse you the full amount. To fulfil quick and urgent delivery requests we have a dedicated team of customer support 7 days a week.</p>
                        <p><strong>Note* You will have to take full responsibility of packaging.</strong></p>
                        <p>You can request a delivery giving us a notice of at least 24 hours (starting at Rs.200), or a few hours for same day delivery (starting at Rs.250). We also accept last minute requests to deliver within 2hours (starting at Rs.350).</p>
                    </div>
                </div>
                <div class="col-md-6">
                    <img src="../send-a-parcel/images/Insurance.svg" class="img-responsive center-block pd-t50" alt="Parcel service in Mumbai, Thane and Navi Mumbai" />
                </div>
            </div>
            <div class="row paddingtb-40 service-all">
                <div class="col-md-6">
                    <img src="../service-material/images/what-other-want.svg" class="img-responsive center-block pd-t50" alt="Cheap Courier Service" />
                </div>
                <div class="col-md-6">
                    <div class="service-padding">
                            ...
                            <li class="item">
                                <figure class="testimonial-hover">
                                    ...
                                    <figcaption class="view-caption">
                                        ...
                                        <p>
                                            <strong>Brian Quadros</strong>
                                            <br />
                                            CEO
                                            <br />
                                            Thomas &amp; Brian Mfg. Pvt. Ltd
                                        </p>
                                        <span class="quotes-right">
                    ...
                    <div class="col-md-12 help-service">
                        <ul id="owl-service" class="owl-carousel owl-alt">
                            ...
                            <li class="item">
                                ...
                                <a href="../cake-delivery-mumbai-thane-navi-mumbai/">
                                    <h4>Cake Delivery</h4>
                                </a>
                            ...
                            <li class="item">
                                ...
                                <a href="../same-day-delivery-of-dress-shoe-accessory/">
                                    <h4>Clothes Delivery</h4>
                                </a>
                            ...
                            <li class="item">
                                ...
                                <a href="../grocery-delivery-in-mumbai/">
                                    <h4>Grocery Delivery</h4>
                                </a>
                            ...
                            <li class="item">
                                ...
                                <a href="../food-delivery-in-mumbai-thane-navi-mumbai/">
                                    <h4>Food Delivery</h4>
                                </a>
                            ...
                            <li class="item">
                                ...
                                <a href="../gift-delivery-in-mumbai-thane-navi-mumbai/">
                                    <h4>Gift Delivery</h4>
                                </a>
                            ...
                            <li class="item">
                                ...
                                <a href="../laptop-mobile-usb-charger-delivery-in-mumbai/">
                                    <h4>Electronic Delivery</h4>
                                </a>
                            ...
                            <li class="item">
                                ...
                                <a href="../chocolate-delivery-service-for-chocolatiers/">
                                    <h4>Chocolate Delivery</h4>
                                </a>
                            ...
                            <li class="item">
                                ...
                                <a href="../cash-pickup-and-delivery-service-in-mumbai/">
                                    <h4>Cash Delivery</h4>
                                </a>
                            ...
                            <li class="item">
                                ...
                                <a href="../same-day-document-delivery-in-mumbai/">
                                    <h4>Document Delivery</h4>
                                </a>
                            ...
                            <li class="item">
                                ...
                                <a href="../arrange-collection-of-many-parcels-in-one-go/">
                                    <h4>Bulk Delivery</h4>
                                </a>
