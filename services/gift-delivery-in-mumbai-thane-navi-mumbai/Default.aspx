<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="services_gift_delivery_Default" %>
...
<head>
    ...
    <title>Gift Delivery Anywhere In Mumbai – Visit Russsh.com!</title>
    <meta name="title" content="Gift Delivery in Mumbai|Gifts, Flowers, Chocolates| Russsh" />
    <meta name="description" content="Send gifts on birthday, anniversary, valentines day or raksha bandhan. Pay Online or COD. Russsh delivers in Mumbai, Thane and Navi Mumbai. Call 8080808315!" />
    ...
    <form id="form1" runat="server">
        ...
        <div class="content">
            <div class="container" style="background: #e9e9eb;">
                <div class="row">
                    <div class="col-md-5">
                        <img src="https://www.russsh.com/services/gift-delivery-in-mumbai-thane-navi-mumbai/images/gift-item.png" style="margin-left: 10px;" class="img-responsive" alt="" title="" />
                    </div>
                    <div class="col-md-5 col-md-offset-1">
                        <div class="service-text">
                            <h1>Gift Delivery In
                                <br />
                                Mumbai</h1>
                            <p>The easiest way of sending a gift to loved one.</p>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row paddingtb-40 service-all">
                <div class="col-md-6">
                    <h2>About our GIFT DELIVERY</h2>
                    <p>We engage in gift deliveries that are quick, prompt and efficient because we know that this is one category where a moment’s delay counts. You can request a delivery giving us a notice of at least 24 hours, or a few hours for same day delivery. We also accept last minute requests to deliver within 2 hours.</p>
                    <p>We understand the delicacy of your gift items and therefore, we take full responsibility of your package. Any sort of damage done due to the negligence of our delivery executive, we swear to reimburse you with the full amount.</p>
                    <p><strong>Note: You will have to take full responsibility of the packaging.</strong></p>
                </div>
                <div class="col-md-6">
                    <img src="../gift-delivery-in-mumbai-thane-navi-mumbai/images/Gift-Delivery.svg" class="img-responsive center-block pd-t50" alt="" />
                </div>
            </div>
            <div class="row paddingtb-40 service-all">
                <div class="col-md-6 col-md-push-6">
					 <div class="service-padding">
                        <h2>3 Massive benefits of using Russsh while delivering gift item</h2>
                        <ul>
