<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PayByNetBanking.aspx.cs" Inherits="Payment_PayByNetBanking" %>
...
<option value="CID004">YES Bank</option>
     ...
     <center>
        <h2>Redirecting to Payment Gateway! Pls wait a moment...</h2>
         <br />
         <br />
