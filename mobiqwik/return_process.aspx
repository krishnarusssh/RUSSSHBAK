...
if (checksumMatch)
{
    ...
    */
    ...
    if (statuscode == "0")
    {
        ...
        String secret_key = "Tn3WtxXYIgXibEMHKn4gyVuup4ig";   // You can change this
        String merchant_id = "MBK7460";                       // You can change this 
        ...
        if (returnDict["flag"] == "true")
        {
            ...
            */
             state1 = returnDict["statusmessage"];
        ...
        {
            Response.Write("Sorry! Payment failed due to some technical reason. Pls call us at 8080808315"+ state1 + "False");
            
            //Response.Write("Fraud Detected.");
        }
        else
        {
            Response.Write("Sorry! Payment failed due to some technical reason. Pls call us at 8080808315"+ state1 + "Error");
    ...
    {
        Response.Write("Sorry! Payment failed due to some technical reason. Pls call us at 8080808315"+ state1 + "Fails");
...
{
    Response.Write("Sorry! Payment failed due to some technical reason. Pls call us at 8080808315"+ state1 + "chkcm");
