<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="services_clothes_delivery_service_Default" %>
...
<%@ Register TagPrefix="fc" TagName="Footer" Src="~/UCNEW/Footer.ascx" %>
    ...
    <head>
        ...
        <title>Clothes, Shoes & Accessory Delivery – Visit Russsh.com!</title>
        <meta name="title" content="Same Day Delivery|Dress, Shoe, Accessories| Russsh.com" />
        <meta name="description" content="Send or receive clothes, shoes and accessories at your convenience. Pay Online or COD. Russsh delivers in Mumbai, Thane and Navi Mumbai. Call 8080808315!" />
    ...
    <body>
        ...
        <div class="content">
            <div class="container" style="background: #e9e9eb;">
                <div class="row">
                    <div class="col-md-5">
                        <img src="https://www.russsh.com/services/same-day-delivery-of-dress-shoe-accessory/images/clothes-item.png" style="margin-left: 10px;" class="img-responsive" alt="" title="" />
                    </div>
                    <div class="col-md-6 col-md-offset-1">
                        <div class="service-text">
                            <h1>Clothes Delivery Service
                                <br />
                                In Mumbai</h1>
                            <p>Easiest way to return or collect clothes around the city.</p>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row paddingtb-40 service-all">
                <div class="col-md-6">
                    <div>
                        <h2>About our SAME DAY CLOTHES DELIVERY service for all</h2>
                        <p>Scratching your heads over sending clothes over long distances? Fret not, we specialize in the safe pickup and delivery of your garments to anywhere from everywhere in Mumbai, Thane and Vashi. Be it an unscheduled meeting or picking up clothes from the drycleaner, we are your right hand. You can place a delivery from the <a href="https://play.google.com/store/apps/details?id=com.russsh.admin.russsh&hl=en">app</a> or the <a href="https://russsh.com/">website</a> by a series of quick, easy steps and within in no time, we will make it happen.</p>
                        <p><strong>Note: You will have to take full responsibility of the packaging.</strong></p>
                    </div>
                </div>
                <div class="col-md-6">
                    <img src="../same-day-delivery-of-dress-shoe-accessory/images/Cloths-Delivery.svg" width="160" height="145" style="padding-top: 80px;" class="img-responsive center-block" alt="" />
                </div>
            </div>
            <div class="row paddingtb-40 service-all">
                <div class="col-md-6 col-md-push-6">
					<div class="service-padding">
                        <h2>3 Massive benefits of using Russsh while delivering clothes</h2>
                        <ul>
                            ...
                            <li><i class="fa fa-caret-right"></i> pay by cash, card or wallet.</li>
                        </ul>
                    </div>
                </div>
                <div class="col-md-6 col-md-pull-6">
                  <img src="../service-material/images/3-massive-benefits.svg" class="img-responsive center-block pd-t30" alt="" />   
                </div>
            </div>
            <div class="row paddingtb-40 service-all">
                <div class="col-md-6">
