<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="services_same_day_document_delivery_Default" %>
...
<head>
    ...
    <title>Document Delivery Anywhere In Mumbai – Visit Russsh.com!</title>
    <meta name="title" content="Document Delivery in Mumbai| Same-Day, Fast, Easy| Russsh" />
    <meta name="description" content="Send or receive documents within 3 hours. Download app to schedule a pick up or delivery. Pay Online or COD. Available in Mumbai, Thane & Navi Mumbai." />
    ...
    <form id="form1" runat="server">
        ...
        <div class="content">
            <div class="container" style="background: #e9e9eb;">
                <div class="row">
                    <div class="col-md-5">
                        <img src="https://www.russsh.com/services/same-day-document-delivery-in-mumbai/images/document-item.png" style="margin-left: 10px;" class="img-responsive" alt="Document delivery service in Mumbai, Thane and Navi Mumbai
" title="" />
                    </div>
                    <div class="col-md-6 col-md-offset-1">
                        <div class="service-text">
                            <h1>Document Delivery Service
                                <br />
                                In Mumbai</h1>
                            <p>Send documents to remote places within a few hours.</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-12 paddingtb-20">
                    <ul class="breadcrumbs">
                        ...
                        <li>Same day document Delivery</li>
                    </ul>
                </div>
            </div>
        </div>
        <div class="container">
            <div class="row paddingtb-40 service-all">
                <div class="col-md-6">
                    <div>
                        <h2>About our SAME DAY DOCUMENT DELIVERY service</h2>
                        <p>Do those huge piles of documents leaving no space on your desk await delivery? Be it in a very short notice such as mere couple hours or ample time such as a whole day, Russsh will deliver them for you adopting all kinds of safety measures. </p>
                        <p>Note: If your documents need to be transported via cab, auto or any other private transport, additional charges may apply and will be communicated to you beforehand. </p>
                        <p>Any damage done to your documents by our delivery executive during the transit is solely upon us followed by full reimbursement. We take 100% responsibility of your package.</p>
                    </div>
                </div>
                <div class="col-md-6">
                    <img src="../same-day-document-delivery-in-mumbai/images/Same-Day-Delievry.svg" class="img-responsive center-block pd-t100" alt="Document courier in Mumbai, Thane and Navi Mumbai
" />
                </div>
            </div>
            <div class="row paddingtb-40 service-all">
                <div class="col-sm-6 col-sm-push-6">
                    <div class="service-padding">
                        <h2>3 Massive benefits of using Russsh while delivering documents</h2>
                        <ul>
