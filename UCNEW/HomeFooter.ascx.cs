...
public partial class UCNEW_HomeFooter : System.Web.UI.UserControl
{
...
string purl="";
        if (Request.QueryString["code"] != null)
        {
            ...
            if (userDetails != "")
            {
                ...
                List<UserDetails3> listUserDetails = serializer1.Deserialize<List<UserDetails3>>("[" + HttpUtility.HtmlDecode(userDetails) + "]");
                ...
                purl=string.Format("https://graph.facebook.com/{0}/picture", listUserDetails[0].id);
                ...
                if (ds.Tables.Count > 0)
                {
                    if (ds.Tables[0].Rows.Count > 0)
                    {
                        if (ds.Tables[0].Rows[0].ItemArray[0].ToString() == "Y")
                        {
                            ...
                            string url = "http://www.russsh.com/about-us/Test.aspx?CLIENT_ID=" + ds.Tables[0].Rows[0].ItemArray[1].ToString() + "&CLIENT_CONTACT=" + ds.Tables[0].Rows[0].ItemArray[3].ToString() + "&CLIENT_NAME=" + ds.Tables[0].Rows[0].ItemArray[2].ToString() + "&type=d&pu="+purl;
