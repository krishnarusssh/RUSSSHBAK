...
<head>
    ...
    <link rel="stylesheet" href="https://www.russsh.com/css1/flexslider.css" type="text/css" media="screen" />
    ...
    <script type="text/javascript" src="https://www.russsh.com/js1/move-top.js"></script>
    <script type="text/javascript" src="https://www.russsh.com/js1/easing.js"></script>
    <!--webfonts-->
    ...
    <script>
        $(function () {
            $("#includeHeaderContent").load("https://www.russsh.com/header_inner.html");
            $("#responsive_menu").load("https://www.russsh.com/responsive_menu_inner.html");
            $("#includedContent").load("https://www.russsh.com/footer.html");
        });
    </script>
      ...
      function attachSignin(element) {
          ...
          auth2.attachClickHandler(element, {},
              function (googleUser) {
                  ...
                  window.location = "https://www.russsh.com/signin/Forwarding.ashx?Email=" + googleUser.getBasicProfile().getEmail() + "&Name=" + googleUser.getBasicProfile().getName() + "&AppID=" + googleUser.getBasicProfile().getId();
              }, function (error) {
                ...
                <div class="container">
                    ...
                    <div class="about divisiontop division" id="divtop" runat="server"  >
                        ...
                        <div class="col-md-12 facebookimg" style="display:non;">
                            ...
                            <asp:ImageButton ID="ImageButton1" runat="server" OnClick="Login"  ImageUrl="https://www.russsh.com/images1/signup_in_facebook.png"/>
                        ...
                        <ProgressTemplate>
                            <div style="border: 5px solid #FF9900; width:250px; height:150px;background-color: #FFFFFF; font-family: Cambria, Cochin, Georgia, Times, 'Times New Roman', serif; font-size: medium; color: #003366; position: fixed; top: 20%; right: 35%;z-index:99991;">
                                <div  style="text-align:center;padding:10px;"><br />
                                    ...
                                    <img alt="" src="https://www.russsh.com/loading_spinner.gif" width="60" />
                                </div>
                            </div>
                        </ProgressTemplate>
                        </asp:UpdateProgress>
...
<%--<asp:Button ID="btnnn" class="SIGN_btn" Text="Have an account? LOGIN" Style="background-color: #959595; color: #FFFFFF;padding:10px;" ValidationGroup="signupf" runat="server" OnClick="btnnn_Click"  />--%>
     ...
     <!--end  logonbox-->
       ...
       <script type="text/javascript" src="https://www.russsh.com/lib1/js/jquery-1.10.1.min.js"> </script>
    <script type="text/javascript" src="https://www.russsh.com/lib1/js/bootstrap/bootstrap.js"></script>
