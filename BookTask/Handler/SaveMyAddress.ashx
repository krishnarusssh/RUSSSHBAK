...
public class SaveMyAddress : IHttpHandler, System.Web.SessionState.IRequiresSessionState 
{
	...
	con.ConnectionString = ConfigurationManager.ConnectionStrings["TESTQUEUEConnectionString"].ToString();
        ...
        if (context.Request.QueryString["cat"] != "" && context.Request.QueryString["cat"] != null)
        {
            Category = context.Request.QueryString["cat"];
        }
        ...
        if (AddressID != null && ClientID != null && AddressName != "" && LastName != "" && MobileNo != "" && Address != "" && Landmark != "" && CityID != null && AreaID != null && PinCode != null && IsFlagFav != null && Category != null && AddressLabel!="")
        {
            ...
            {     
                ...
                cmd.Parameters.Add("@Address", SqlDbType.VarChar, 500).Value = Address.Replace("~"," ");
                ...
                cmd.Parameters.Add("@Category", SqlDbType.Char, 1).Value = Category.Trim();
            ...
            if (ds.Tables.Count > 0)
            {
                if (ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    {
                        Result = ds.Tables[0].Rows[0].ItemArray[0].ToString()+"," + ds.Tables[0].Rows[0].ItemArray[1].ToString();
                    }
                }
            }
