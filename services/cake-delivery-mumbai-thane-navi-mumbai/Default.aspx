<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="services_cake_delivery_Default" %>
...
<%@ Register TagPrefix="fc" TagName="Footer" Src="~/UCNEW/Footer.ascx" %>
    ...
    <head>
        ...
        <title>Cake Delivery Anywhere In Mumbai – Visit Russsh.com!</title>
       <meta name="title" content="Cake Delivery In Mumbai|Best For Bakers| Upto 1.5kgs|" />
       <meta name="description" content="Russsh delivers cake up to 1.5kg . Bakers should ask for monthly packages. Pay Online or COD. Russsh delivers in Mumbai, Thane and Navi Mumbai. Call 8080808315!" />
        ...
        <uc:Header ID="Header" runat="server" MinValue="1" MaxValue="10" />
            ...
            <div class="content">
                <div class="container" style="background: #e9e9eb;">
                    <div class="row">
                        <div class="col-md-5">
                            <img src="https://www.russsh.com/services/cake-delivery-mumbai-thane-navi-mumbai/images/cake-item.png" class="img-responsive" alt="Cake Delivery in Mumbai, Thane and Navi Mumbai
" title="" />
                        </div>
                        <div class="col-md-5 col-md-offset-1">
                            <div class="service-text">
                                <h1>Cake Delivery Service<br />
                                    In Mumbai</h1>
                                <p>Impress customers with on-demand cake deliveries.</p>
                            </div>
                        </div>
                    </div>
                    <div class="row service-bottom">
                        <div class="service-box">
                            <div class="internal">
                                <p>User Rating</p>
                                 <p>Coming Soon
                                   <%-- <img src="../service-material/images/rating.jpg" alt="" title="" />--%></p>
                            </div>
                            <div class="internal">
                                <p>Total Cake Delivered</p>
            ...
            <div class="container">
                <div class="row paddingtb-40 service-all">
                    <div class="col-md-6">
                        <div>
                            <h2>About our CAKE DELIVERY service</h2>
                            <p>Russsh delivers cake (up to 1.5 Kgs), cupcake, cake pops and other baked food items within a few hours from placing a request via phone call, <a href="https://russsh.com/">website</a> or <a href="https://play.google.com/store/apps/details?id=com.russsh.admin.russsh&hl=en">mobile app</a>.
                                <br />
                                You can request a delivery giving us a notice of at least 24 hours (starting at Rs.200), or a few hours for same day delivery (starting at Rs.250). We also accept last minute requests to deliver within 2 hours (starting at Rs.350).</p>
                            <p>
                                We take 100% responsibility of the cake. If the cake is damaged or lost during transit because of the negligence of one of our delivery staff, we will reimburse you the full amount. To fulfil quick and urgent delivery requests we have a dedicated team of customer support 7 days a week.<br />
                                <strong>Note* You will have to take full responsibility of packaging.</strong>
                            </p>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <img src="../cake-delivery-mumbai-thane-navi-mumbai/images/Cake-Delivery.svg" width="190" height="130" class="img-responsive center-block pd-t100" alt="Birthday Cake delivery in Mumbai, Thane and Navi Mumbai
" />
                    </div>
                </div>
                <div class="row paddingtb-40 service-all">
                    <div class="col-md-6 col-md-push-6">
						 <div class="service-padding">
                            <h2>3 Massive benefits of using Russsh while delivering a cake</h2>
                            <ul>
                    ...
                    <div class="col-md-6 col-md-pull-6">
                        <img src="../service-material/images/3-massive-benefits.svg" style="padding-top: 10px;" class="img-responsive center-block" alt="" />
                    </div>
                </div>
                <div class="row paddingtb-40 service-all">
                    <div class="col-md-6">
...
<script type="text/javascript">
     ...
     setInterval(function() 
     {
         if (c==5)
         {
           $('#anim1').show('slow').fadeIn('slow');
         }
           var e=0;
           $(".gift-trigger").click(function(){ 
           $(".tap-open").stop().animate({right: ++e%2*108 }, '100');
           setTimeout(function() {
           $('.bank').slideDown().show('slow');
           $(".fixed").fadeTo(1000, 1);
           }, 2000);
           });
           if(c==20)
           {
               // $('#anim1').hide('slow');
               $('.bank').slideUp().hide('slow');
               $(".tap-open").stop().animate({right:++e%2*26 }, '100');
               $(".box-only").animate({bottom:++e%3*-30 }, '200');
           }
            if(c==25)
           { 
               $(".box-only").animate({bottom:++e%3*-60 }, '200');
           }
           
           if(c==30)
           { 
                 $('#anim1').hide('slow');
                 $(".box-only").animate({bottom:++e%2*10 }, '200');
                 $('#anim2').show('slow').fadeIn('slow');
                 $(".fixed").fadeTo(1000, 1);
               
            }
            
                $(".gift-trigger2").click(function(){
                $(".tap-open").stop().animate({right: ++e%2*108 }, '100');
                setTimeout(function() {
                $('.bank').slideDown().show('slow');
                $(".fixed").fadeTo(1000, 1);
           ...
           {       
            ...
            if(c==120)
                 ...
                 { 
                         $('#anim2').hide('slow');
                         $(".box-only").animate({bottom:++e%3*20 }, '200');
                         $('.bank').slideUp().hide('slow');
                         $('#anim3').show('slow').fadeIn('slow');
                         $(".fixed").fadeTo(1000, 1);
                       
                    }
                    
                $(".gift-trigger3").click(function(){
                $(".tap-open").stop().animate({right: ++e%2*108 }, '100');
                setTimeout(function() {
                $('.bank').slideDown().show('slow');
                $(".fixed").fadeTo(1000, 1);
                ...
                if(c==145)
               {
                ...
                if(c==150)
                   { 
                         ...
                         $(".box-only").animate({bottom:++e%2*10 }, '200');
                         $('.bank').slideUp().hide('slow');
                         $('#anim4').show('slow').fadeIn('slow');
                        // $(".tap-open").stop().animate({right:++e%2*26 }, '100');
                         $(".fixed").fadeTo(1000, 1);
                       
                    }
                    
                $(".gift-trigger4").click(function(){
                $(".tap-open").stop().animate({right: ++e%2*108 }, '100');
                setTimeout(function() {
                $('.bank').slideDown().show('slow');
                $(".fixed").fadeTo(1000, 1);
               ...
               $(".box-only").animate({bottom:++e%3*-60 }, '200');
                ...
                if(c==240)
                   { 
                         ...
                         $(".box-only").animate({bottom:++e%2*10 }, '200');
                         $('.bank').slideUp().hide('slow');
                         $('#anim5').show('slow').fadeIn('slow');
                         //$(".tap-open").stop().animate({right:++e%2*26 }, '100');
                         $(".fixed").fadeTo(1000, 1);
                       
                    }
                    
                $(".gift-trigger5").click(function(){
                $(".tap-open").stop().animate({right: ++e%2*108 }, '100');
                setTimeout(function() {
                $('.bank').slideDown().show('slow');
                $(".fixed").fadeTo(1000, 1);
                ...
                $('.character').hide('slow').fadeOut('1000');
                });
