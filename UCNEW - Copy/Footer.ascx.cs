    ...
    public void SetFacebookData()
    {
        ...
        if (Request.QueryString["code"] != null)
        {
            ...
            if (userDetails != "")
            {
                ...
                List<UserDetails> listUserDetails = serializer1.Deserialize<List<UserDetails>>("[" + HttpUtility.HtmlDecode(userDetails) + "]");
                ...
                if (ds.Tables.Count > 0)
                {
                    if (ds.Tables[0].Rows.Count > 0)
                    {
                        ...
                        else
                        {
                            ...
                            Response.Redirect("https://www.russsh.com/about-us/Test.aspx?CLIENT_ID=" + ds.Tables[0].Rows[0].ItemArray[1].ToString() + "&CLIENT_CONTACT=" + ds.Tables[0].Rows[0].ItemArray[3].ToString() + "&CLIENT_NAME=" + Name + "&APPID=" + Id + "&type=Test&source=F&Email=" + Email + "");
