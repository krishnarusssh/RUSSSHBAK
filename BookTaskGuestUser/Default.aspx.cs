    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            try
            {
                ...
                // For Vrification Code..
                if (Session["Vcode"] != "" && Session["Vcode"] != null && Session["Vcode"] != "0")
                {
                    hdnVcode.Value = Session["Vcode"].ToString();
                }
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            try
            {
                ...
                cmd = new SqlCommand("BookATaskFrom_Web_Quick_Perks", con);    // by sushama dt:24 jun 2016
        ...
        if (TaskID != 0)
        {
            ...
            if (sflag == "Y")
            {
                if (OnlinePayment == 0)
                {
                    ...
                    string MessagePart = Server.UrlEncode("Dear " + Session["CLIENT_NAME"].ToString() + ", Thank you for booking your task with Russsh.com You will receive your confirmation within the next 20 minutes.");
            ...
            Session["CEMAIL"] = Session["CLIENT_EMAIL"].ToString();
            Session["CNAMEW"] = Session["CLIENT_NAME"].ToString();
            ...
            {
                Session["NEWBOOKINGID"] = TaskID;
                Response.Redirect("https://www.russsh.com/Task_Payment");
            }
            else
            {
                //sushama
                ...
                "alert('Task booked sucessfully.Your Task ID is "+TaskID.ToString()+". Please note this Task ID for tracking and communication purpose.'); window.location='" +
                  "https://www.russsh.com/GuestUser.aspx?Verifiedcode="+hdnVcode.Value+"';", true);
            }
        }
